<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <p class="mt-6 text-gray-500 leading-relaxed">
        Aplikasi ini dirancang untuk memudahkan warga dalam mengakses berbagai layanan yang disediakan oleh kelurahan. Anda dapat melakukan pendaftaran, pengajuan layanan, dan mendapatkan informasi terkait layanan yang tersedia.
    </p>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Untuk petunjuk penggunaan, silahkan klik link berikut.
        </p>
